...
for f in storage_password rsa_passphrase rsa_private_key rsa_public_key ssh_private_key ssh_public_key; do
...
echo "=== INIT-ENVNATIVE OK: decoys ignored, both dirs kept, bundle 0600 + -k compat, bundle-free backup ==="
